from poker_hand.dptables import SUITS
from poker_hand.hashtable import FLUSH
from poker_hand.hashtable_hand import NO_FLUSH_5
from poker_hand.hash import hash_quinary
